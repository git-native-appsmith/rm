				...
				function getPropertyMaterialColumnsConfig(rowData) {
					var columnsConfig =  {
						columns: [
							...
							{ title: rowData.RECIPE_ITEM_TYPE === 'DOS'? i18next.t("MATERIAL NAME") : i18next.t("PROPERTY NAME"), field: "MATERIAL_NAME_SHORT", headerFilter: true, tooltip: true, headerTooltip: true, minWidth: '160px'},
							...
							{ title: i18next.t("SPECIFIC WEIGHT"), field: "SPECIFIC_WEIGHT", visible: rowData.RECIPE_ITEM_TYPE === 'DOS'? true : false, headerTooltip: true},
					...
					function getColumnsConfig() {
						var columnsConfig =  {
							columns: [		
								...
								{ title: i18next.t("BALES"), field: "BALES", editor: "input", tooltip:true,visible: columnConfiguration.includes('BALES') ? true: false,
										...
										for(let i=0; i <tableData.length;i++)
										{
											if(tableData[i].RECIPE_ITEM_TYPE != 'CMD') {
												...
												if(tableData[i].RECIPE_FUNCTION != 'CAL') {
													...
													tableData[i].ACTUAL_VALUE = roundFunction(per, 2);
